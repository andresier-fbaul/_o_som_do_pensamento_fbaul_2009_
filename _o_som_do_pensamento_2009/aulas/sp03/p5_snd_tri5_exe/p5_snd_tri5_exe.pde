...
/*
  ...
  exercício com os snd tris:
  
  1. actualizar sempre a forma sem apagar o fundo
  2. distintas rotações dependendo do som
  3. movimento ou de leitura, ou de rotação com orientação,
  ou outro inventado por vocês
  4. cores alteradas, tamanhos e se quiserem com outras
  formas gráficas
  5. gravar umas imagens e escolher 1 ou 2
