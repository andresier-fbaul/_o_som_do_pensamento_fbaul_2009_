// desenhar uma esfera 3d a partir de um centro
// e rodar a câmara em torno da cena
// suavizar os valores e novas maneiras de desenhar
...
//  beginShape(TRIANGLE_FAN); 
  for(int i=0; i<(l.length-grelha-1);i++){
    int down = (i+grelha-1) % l.length;
    l[i].callverts();
    l[down].callverts();
