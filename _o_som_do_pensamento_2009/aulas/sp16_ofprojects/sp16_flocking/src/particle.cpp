...
//	seperation.distance		= 155;
//	alignment.distance		= 100;
//	cohesion.distance		= 200;
	
	seperation.strength		= .03;
    alignment.strength		= .015;
	cohesion.strength		= .015;

//	seperation.strength		= .0091;
//    alignment.strength		= .0095;
//	cohesion.strength		= .00515;
	
	
//	int mod = (int) ofRandom(1,3);
//	float mainforce = ofRandom(0.01,0.10);
//	float f1 = mainforce * ofRandom(0.3, 0.7);
//	float f2 = mainforce * ofRandom(0.3, 0.7);
//	
//	switch(mod){	
//		case 0:
//			seperation.strength		= mainforce;
//			alignment.strength		= f1;
//			cohesion.strength		= f2;			
//			break;
//
//		case 1:
//			seperation.strength		= f1;
//			alignment.strength		= mainforce;
//			cohesion.strength		= f2;			
//			break;
//
//		case 2:
//			seperation.strength		= f1;
//			alignment.strength		= f2;
//			cohesion.strength		= mainforce;			
//			break;
//	}
