...
int w = 0;
 ...
 //       float inverso;
        ...
        float green = CLAMP( ofMap (z , ZMAX , 0 , 0, 400)  , 0, 400);
...
void testApp::update(){
    ...
    long double s = 100.000000000f;//ofMap(mouseX,0,ofGetWidth(),0.,1000.0f);
...
//codigo dos botoes
    ...
    camx=camx+ofMap(joyx,-255,255,-100,100);
    ...
    camy=camy+ofMap(joyy,255,-255,-100,100);
