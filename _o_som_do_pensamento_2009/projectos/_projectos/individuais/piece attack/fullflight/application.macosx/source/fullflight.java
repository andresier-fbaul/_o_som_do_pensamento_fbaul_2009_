...
Sky sky;
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--present", "--bgcolor=#000000", "--hide-stop", "fullflight" });
  }


/*
static public void main(String args[]) {
  PApplet.main(new String[] { "--present","--present","fullflight" });
}
*/
...
class Aviao{
  ...
  public void constroi(){
     ini = pos = new PVector(  random(width/2,2*width), random(-250,2500), random(-1550,-200)     ); 
