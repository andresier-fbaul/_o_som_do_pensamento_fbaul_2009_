...
public class wargames_applet extends PApplet {
...
//    PApplet.main(new String[] { "--present", "wargames" });
//  }



public void setup(){
  size(1024,600,OPENGL);//screen.width,screen.height,OPENGL);
...
//    glut.glutBitmapString(glut.BITMAP_9_BY_15, name+" "+hitcount);
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--present", "--bgcolor=#666666", "--hide-stop", "wargames_applet" });
  }
}
