...
public void draw(){
  ...
  if(mousePressed){
    ...
    strokeWeight(d*0.1f);
    stroke(147,0,0, 80); // cor branca com alpha reduzido
...
class Scribler{
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--present", "--bgcolor=#666666", "--hide-stop", "p5_desenhar2a_exercicio" });
  }
}
