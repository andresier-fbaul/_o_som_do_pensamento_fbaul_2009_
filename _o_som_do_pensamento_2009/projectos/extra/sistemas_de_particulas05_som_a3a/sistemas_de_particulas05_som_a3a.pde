...
Minim minim;
AudioInput in;
float MINSOUND = 0.01;//0.01; // o valor de som que despoleta a criação de sistemas
...
color cores[] = { #000000, #000000, #ADA9A9, #000000, #444846 ,
                  #BFC9C2, #000000, #000000, #FAFAFA, #FAFAFA};
...
void setup(){
  ...
  for(int i=0; i < sp.length; i++){    
    color c = cores[i];///cores[(int)random(cores.length)]; // escolher uma cor aleatória da array de cores    
