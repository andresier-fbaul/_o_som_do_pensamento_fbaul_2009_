...
//  size(1024,768,OPENGL); // ou 800 x 600, escolham...
  ...
  oscP5 = new OscP5(this,16000); // ler na porta 16000
  esquerda = null;//new NetAddress("127.0.0.1",16001);/// para teste, depois usamos numeros de rede no pp dia...;

  direita = new NetAddress("127.0.0.1",16001); // o da direita deste é o do centro
  /// para teste, depois usamos numeros de rede no pp dia...;
//  self = new NetAddress("127.0.0.1",16000);/// para teste, depois usamos numeros de rede no pp dia...;
...
//    Particula part = new Particula(0.f,0.f);
